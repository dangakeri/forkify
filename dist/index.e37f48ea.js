...
var _webImmediateJs = require("core-js/modules/web.immediate.js"); // window.addEventListener('haschange', showRecipe);
...
const showRecipe = async function() {
    ...
    <figure class="recipe__fig">
          <img src="src/${recipe.image}" alt="${recipe.title}" class="recipe__img" />
